...
data_dirs = [
    ...
    './interpol_data_lin/interpol_data_lin/2023/02/02',
    './interpol_data_lin/interpol_data_lin/2023/03/03',
    './interpol_data_lin/interpol_data_lin/2023/04/04',
    './interpol_data_lin/interpol_data_lin/2023/05/05',
    './interpol_data_lin/interpol_data_lin/2023/06/06',
    './interpol_data_lin/interpol_data_lin/2023/07/07',
    './interpol_data_lin/interpol_data_lin/2023/08',
    './interpol_data_lin/interpol_data_lin/2023/09/09',
    './interpol_data_lin/interpol_data_lin/2023/10/10',
    './interpol_data_lin/interpol_data_lin/2023/11/11',
    './interpol_data_lin/interpol_data_lin/2023/12/12'
]
output_dirs = [
...
def predict_and_save(data_file, output_dir, plot_limit=10):
    ...
    for trajectory, scaler, mmsi, indices in trajectories:
        ...
        plt.scatter(predicted_positions[:, 1], predicted_positions[:, 0], label=f'Prédiction {mmsi}', color='red', linestyle='--')
